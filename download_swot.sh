...
local=$MYGROUP/data/SWOT/l2_karin_unsmoothed

remote=aviso:/swot_products/l2_karin/l2_lr_ssh/PGC0/Expert/
local=$MYGROUP/data/SWOT/l2_karin_versionC

include="cycle_524*/*_021_*.nc" # Browse 
#include="cycle_5[1-3]*/*_021_*.nc" # Browse 
